	...
	if gui.main then
		...
		local function b(name, labelColor, textColor)
			local label = create 'ImageLabel' { -- 522 x 130
				Name = name,
				BackgroundTransparency = 1.0,
					Image = 'rbxassetid://137727326007735',--REPLACE THERES NOTHING HERE (GREY SCALE BUTTON IDK WHAT THAT IS)
		...
		local cancel = create 'ImageLabel' { -- 522 x 130
			Name = 'Cancel',
			BackgroundTransparency = 1.0,
				Image = 'rbxassetid://137727326007735',--this too greyscalebutton
	...
	if not targets then
		...
		for i = 1, 6 do
			targets[i] = create 'ImageLabel' { -- 522 x 130
				Name = 'Move'..i,
				BackgroundTransparency = 1.0,
					Image = 'rbxassetid://137727326007735',
	...
	if not moves then
		...
		for i = 1, 4 do
			moves[i] = create 'ImageLabel' { -- 522 x 130
				Name = 'Move'..i,
				BackgroundTransparency = 1.0,
					Image = 'rbxassetid://137727326007735',--another grey scale button
				Size = UDim2.new(1.0, 0, 1.0, 0),
				Parent = container,
